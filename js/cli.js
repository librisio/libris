...
const CLI = new vlib.CLI({name: "libris", version: "1.1.1", commands: [
     ...
     *      @name: --api-key
     *      @type: string
     *      @desc: The {{BRAND_NAME}} API key, when undefined the environment varible `LIBRIS_API_KEY` will be used.
     *      @required: false
     *  @usage: 
     *      @CLI:
     *          $ libris --generate
     ...
     */
    {
        ...
        args: [
            ...
            {id: "--api-key", type: "string", description: `The Libris API key, when undefined the environment varible "LIBRIS_API_KEY" will be used.`},
        ],
        callback: async ({
            source = null,
            sources = null,
