const vlib=require("/Users/administrator/persistance/"+"private/dev/vinc/vlib/js/vlib.js")
const vhighlight=require("/Users/administrator/persistance/"+"private/dev/vinc/vhighlight/vhighlight.js")
class Theme{
constructor({
...
codeline_bg="#212938",
divider_bg="#FFFFFF10",
scroll_track_bg="#FFFFFF10",
scroll_thumb_bg="#FFFFFF10",
...
this.sidebar_fg=sidebar_fg;
this.subtext_fg=subtext_fg;
...
this.scroll_track_bg=scroll_track_bg;
this.scroll_thumb_bg=scroll_track_bg;
...
codeline_bg:"#EDF1F4",
divider_bg:"#EDF0F3",
scroll_track_bg:"#00000010",
scroll_thumb_bg:"#00000010",
token_string:"#C7B738",
...
codeline_bg:"#212938",
divider_bg:"#FFFFFF15",
scroll_track_bg:"#FFFFFF20",
scroll_thumb_bg:"#FFFFFF20",
...
output_path:{type:["string","array"], default:null},
...
static host="test.vandenberghinc.com";
static port=443;
...
throw Error(`Invalid type for parameter "config", the valid type is "Config", "obect" or "string".`);
}
...
if (this.config.output_path!=null){
let outputs;
if (typeof this.config.output_path==="string"){
outputs=[this.config.output_path];
} else if (Array.isArray(this.config.output_path)){
outputs=this.config.output_path;
} else {
throw Error(`${this.config.config_path.str()}: Invalid type for config attribute "output_path", the valid types are "null", "string" or "array".`);
}
